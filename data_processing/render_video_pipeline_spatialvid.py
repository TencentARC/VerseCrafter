...
def parse_args():
    ...
    parser.add_argument(
        '--csv_path', type=str,
        default="/path/to/SpatialVID_HQ_merged_train.csv",
        help='CSV file with video and npz paths'
    )
    parser.add_argument('--device', type=str, default='cuda', help='Device to use')
    parser.add_argument(
        '--video_root', type=str,
        default="/path/to/spatialvid_root/",
...
def colorize_density_maps_alpha(
    ...
    Args:
        density_maps: List of (H, W) density maps
...
def main():
    ...
    for idx, row in tqdm(
        ...
        # Build full path
        # spatialvid
        # video_file = "0b0cc96c-878f-510e-8d4b-5d1b1fd0b8f2_0000060_0000141.mp4"
        # npz_file = "0b0cc96c-878f-510e-8d4b-5d1b1fd0b8f2_0000060_0000141_depth_pose.npz"
        full_video_path = os.path.join(args.video_root, f"{crowdDensity}_clip", video_file)
        full_npz_path = os.path.join(args.video_root, f"{crowdDensity}_clip", npz_file)
